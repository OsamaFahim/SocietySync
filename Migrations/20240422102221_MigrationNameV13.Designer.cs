...
namespace SocietySync.Migrations
{
    ...
    [Migration("20240422102221_MigrationNameV13")]
    partial class MigrationNameV13
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocietySync.Models.Announcement", b =>
                {
                    ...
                    b.Property<string>("PostedBySocietyName")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("PostedBySocietyName");
            ...
            modelBuilder.Entity("SocietySync.Models.Announcement", b =>
                {
                    b.HasOne("Society", "PostedBySociety")
                        .WithMany("Announcements")
                        .HasForeignKey("PostedBySocietyName");

                    b.HasOne("SocietySync.Models.User", "PostedByUser")
                        .WithMany("Announcements")
                        .HasForeignKey("PostedByUserId");

                    b.Navigation("PostedBySociety");
